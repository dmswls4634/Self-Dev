    ...
    render() {
        return (
            <>
                <Nav tabs>
                    <NavItem>
                        <NavLink onClick={() => { this.toggle('React'); }}>첫 번째</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink onClick={() => { this.toggle('200'); }}>두 번째</NavLink>
                    </NavItem>
                </Nav>
                <TabContent activeTab={this.state.TabState}>
                    <TabPane tabId="React"><h3>React1</h3></TabPane>
                    <TabPane tabId="200"><h3>React2</h3></TabPane>
                </TabContent>
            </>
        )
    }
