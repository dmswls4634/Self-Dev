        ...
        if(this.fnValidate()){
            ...
            try {
                ...
                if(body == "succ"){
                    ...
                    alert('작업중 오류가 발생하였습니다3.')
                }  
            } catch (error) {
                alert('작업중 오류가 발생하였습니다4.')
            }
        }
    };
                            ...
                            <article className="res_w">
                                ...
                                <div className="tb_outline">
                                    ...
                                    <div className="btn_confirm mt20" style={{"margin-bottom": "44px"}}>
                                        ...
                                        >저장</a>
                                        <a href="#" className="bt_ty bt_ty2 submit_ty1 modifyclass" onClick={(e) => {
                                            e.preventDefault();
                                            this.submitClick('modify', e);}}
                                        >수정</a>
                                    </div>
                                </div>
                            </article>
...
export default withRouter(SoftwareView);